        ...
        <table className="w-3/4 table-auto">
          ...
          <tbody>
            {filteredJobs.map((job) => (
              <tr key={job.id}>
                <td className="px-6 py-3 text-center border font-light border-gray-300 dark:border-gray-500">{job.company}</td>
                <td className="px-6 py-3 text-center border font-light border-gray-300 dark:border-gray-500">{job.title}</td>
                <td className="px-6 py-3 text-center border font-light border-gray-300 dark:border-gray-500">{job.status}</td>
                <td className="px-6 py-3 text-center border font-light border-gray-300 dark:border-gray-500">{job.date}</td>
                <td className="px-6 py-3 text-center border font-light border-gray-300 dark:border-gray-500">
